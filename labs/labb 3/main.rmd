...
Vi ser redan i första plotten till vänster att vi verkar inte följa en linjär trend. Vi ser även i residualplotten att det inte finns någon konstant värde pga. den förändringen i avståndet från 0-linjen som inte är konstant, mao. spridningen verkar förändras i olika delar av plotten. 
Residualerna verkar följa en normalfördelning förutom vid dem extrema värden i svansarna. Vi har därmed inte uppfyllt kraven på 
...
plot(df1$år, residual1, xlab = "År, 1880-1929", ylab ="")
abline(a = 0, b = 0, lty = "dotted")
qqnorm(residual1)
qqline(residual1)
